...
extern void l_module_OC_EchoRequestOutput__request$say2(void *thisarg, unsigned int request$say2_meth, unsigned int request$say2_v);
...
extern void l_module_OC_Echo__request$say2(void *thisarg, unsigned int request$say2_meth, unsigned int request$say2_v);
extern bool l_module_OC_Echo__request$say2__RDY(void *thisarg);
extern bool l_module_OC_Echo__request$say__RDY(void *thisarg);
extern void l_module_OC_Echo__x2y(void *thisarg);
extern bool l_module_OC_Echo__x2y__RDY(void *thisarg);
extern void l_module_OC_Echo__y2x(void *thisarg);
extern bool l_module_OC_Echo__y2x__RDY(void *thisarg);
extern void l_module_OC_Echo__y2xnull(void *thisarg);
extern bool l_module_OC_Echo__y2xnull__RDY(void *thisarg);
class l_module_OC_Echo {
public:
  l_ainterface_OC_EchoRequest request;
...
public:
  ...
  void x2y(void) { l_module_OC_Echo__x2y(this); }
  bool x2y__RDY(void) { return l_module_OC_Echo__x2y__RDY(this); }
  void y2x(void) { l_module_OC_Echo__y2x(this); }
  bool y2x__RDY(void) { return l_module_OC_Echo__y2x__RDY(this); }
  void y2xnull(void) { l_module_OC_Echo__y2xnull(this); }
  bool y2xnull__RDY(void) { return l_module_OC_Echo__y2xnull__RDY(this); }
  void setindication(l_ainterface_OC_EchoIndication *v) { indication = v; }
};
...
extern void l_module_OC_Connect__swap2_rule(void *thisarg);
extern bool l_module_OC_Connect__swap2_rule__RDY(void *thisarg);
extern void l_module_OC_Connect__swap_rule(void *thisarg);
extern bool l_module_OC_Connect__swap_rule__RDY(void *thisarg);
class l_module_OC_Connect {
public:
...
public:
  ...
  void swap2_rule(void) { l_module_OC_Connect__swap2_rule(this); }
  bool swap2_rule__RDY(void) { return l_module_OC_Connect__swap2_rule__RDY(this); }
  void swap_rule(void) { l_module_OC_Connect__swap_rule(this); }
  bool swap_rule__RDY(void) { return l_module_OC_Connect__swap_rule__RDY(this); }
};
typedef struct {
