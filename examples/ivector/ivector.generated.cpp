...
void l_module_OC_Fifo1_OC_3__out$deq(void *thisarg) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        thisp->full_shadow = 0;
        thisp->full_valid = 1;
}
bool l_module_OC_Fifo1_OC_3__out$deq__RDY(void *thisarg) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        return thisp->full;
}
void l_module_OC_Fifo1_OC_3__in$enq(void *thisarg, l_struct_OC_ValuePair in$enq_v) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        thisp->element = in$enq_v;
        thisp->full_shadow = 1;
        thisp->full_valid = 1;
}
bool l_module_OC_Fifo1_OC_3__in$enq__RDY(void *thisarg) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        return (thisp->full) ^ 1;
}
l_struct_OC_ValuePair l_module_OC_Fifo1_OC_3__out$first(void *thisarg) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        return thisp->element;
}
bool l_module_OC_Fifo1_OC_3__out$first__RDY(void *thisarg) {
        l_module_OC_Fifo1_OC_3 * thisp = (l_module_OC_Fifo1_OC_3 *)thisarg;
        return thisp->full;
}
void l_module_OC_Fifo1_OC_3::run()
{
    commit();
}
void l_module_OC_Fifo1_OC_3::commit()
{
    if (full_valid) full = full_shadow;
    full_valid = 0;
}
void l_module_OC_FifoPong__out$deq(void *thisarg) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
...
bool l_module_OC_FifoPong__out$deq__RDY(void *thisarg) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
        return ((thisp->element2.out.deq__RDY()) | ((thisp->pong) ^ 1)) & ((thisp->element1.out.deq__RDY()) | (thisp->pong));
}
void l_module_OC_FifoPong__in$enq(void *thisarg, l_struct_OC_ValuePair in$enq_v) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
        if (thisp->pong)
...
bool l_module_OC_FifoPong__in$enq__RDY(void *thisarg) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
        return ((thisp->element2.in.enq__RDY()) | ((thisp->pong) ^ 1)) & ((thisp->element1.in.enq__RDY()) | (thisp->pong));
}
l_struct_OC_ValuePair l_module_OC_FifoPong__out$first(void *thisarg) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
...
bool l_module_OC_FifoPong__out$first__RDY(void *thisarg) {
        l_module_OC_FifoPong * thisp = (l_module_OC_FifoPong *)thisarg;
        return ((thisp->element2.out.first__RDY()) | ((thisp->pong) ^ 1)) & ((thisp->element1.out.first__RDY()) | (thisp->pong));
}
void l_module_OC_FifoPong::run()
{
    element1.run();
    element2.run();
    commit();
}
void l_module_OC_FifoPong::commit()
{
...
void l_module_OC_IVector__respond0(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
...
bool l_module_OC_IVector__respond0__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo0.out.first__RDY()) & (thisp->fifo0.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond1(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond1__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo1.out.first__RDY()) & (thisp->fifo1.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond2(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond2__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo2.out.first__RDY()) & (thisp->fifo2.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond3(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond3__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo3.out.first__RDY()) & (thisp->fifo3.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond4(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond4__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo4.out.first__RDY()) & (thisp->fifo4.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond5(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond5__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo5.out.first__RDY()) & (thisp->fifo5.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond6(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond6__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo6.out.first__RDY()) & (thisp->fifo6.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond7(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond7__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo7.out.first__RDY()) & (thisp->fifo7.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond8(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond8__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo8.out.first__RDY()) & (thisp->fifo8.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__respond9(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_module_OC_IVector__respond9__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        return ((thisp->fifo9.out.first__RDY()) & (thisp->fifo9.out.deq__RDY())) & (thisp->ind->heard__RDY());
}
void l_module_OC_IVector__in$say(void *thisarg, unsigned int in$say_meth, unsigned int in$say_v) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
        l_struct_OC_ValuePair temp;
        temp.b = in$say_v;
...
bool l_module_OC_IVector__in$say__RDY(void *thisarg) {
        l_module_OC_IVector * thisp = (l_module_OC_IVector *)thisarg;
...
void l_module_OC_IVector::commit()
{
