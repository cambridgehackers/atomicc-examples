...
extern void l_module_OC_Echo__say(void *thisarg, unsigned int say_v);
extern bool l_module_OC_Echo__say__RDY(void *thisarg);
class l_module_OC_Echo {
public:
  l_module_OC_Fifo1 fifo;
  l_module_OC_EchoIndication *ind;
...
public:
  ...
  void say(unsigned int say_v) { l_module_OC_Echo__say(this, say_v); }
  bool say__RDY(void) { return l_module_OC_Echo__say__RDY(this); }
  void setind(l_module_OC_EchoIndication *v) { ind = v; }
};
class l_class_OC_EchoTest;
class l_class_OC_EchoTest {
public:
  l_module_OC_Echo echo;
