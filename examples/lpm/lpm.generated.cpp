...
void l_class_OC_Lpm__request$say(void *thisarg, unsigned int request$say_meth, unsigned int request$say_v) {
        l_class_OC_Lpm * thisp = (l_class_OC_Lpm *)thisarg;
        l_struct_OC_ValuePair temp;
...
bool l_class_OC_Lpm__request$say__READY(void *thisarg) {
        l_class_OC_Lpm * thisp = (l_class_OC_Lpm *)thisarg;
